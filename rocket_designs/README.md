...
| Version | Description | Status | Height | Mass | Landed Z |
|---------|-------------|--------|--------|------|----------|
| [v0](design_v0.md) | Simple cylinder (baseline) | Deprecated | 2.0 m | 10.0 kg | 1.00 m |
| [v1](design_v1.md) | Two landing legs | Deprecated | ~4.1 m | 10.0 kg | 1.85 m |
| [v2](design_v2.md) | Three legs (tripod) | **Current** | ~4.1 m | 9.71 kg | 1.93 m |
